...
<div class="container " > 
    <div class="row content">
        ...
        <a  href="create-student-info.php"  class="button button-purple mt-12 pull-right">createStudent</a> 
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                <label for="email_address">Address Where u Want:</label>
                <input type="text" class="form-control" value="<?php if (isset($student_info['email_address'])) {
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="gender" id="gender">
                    ...
                    <option value="Birthdayparty" <?php if (isset($student_info['gender']) && $student_info['gender'] == 'Birthdayparty') {
            echo 'selected';
        } ?>>Birthdayparty</option>
                    <option value="Marrage" <?php if (isset($student_info['gender']) && $student_info['gender'] == 'Marrage') {
            echo 'selected';
        } ?>>Marrage</option>
                    <option value="namingcermony" <?php if (isset($student_info['gender']) && $student_info['gender'] == 'namingcermony') {
            echo 'selected';
        } ?>>Naming Cermony</option>
                    <option value="engagement" <?php if (isset($student_info['gender']) && $student_info['gender'] == 'engagement') {
            echo 'selected';
        } ?>>Engagment</option>
